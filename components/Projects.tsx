...
const projects = [
  ...
  { title: "Prographr Templates", tag: "E-commerce", index: "02", desc: "Template marketplace with SSLCommerz payments, Google One Tap auth, and a complete admin panel.", stack: ["React", "Node.js", "MongoDB", "SSLCommerz"], img: "/projects/prographr.png", href: "https://prographr-templates.netlify.app" },
