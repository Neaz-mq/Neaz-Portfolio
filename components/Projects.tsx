...
const projects = [
  ...
  { title: "Mojito", tag: "Cocktail Landing", index: "04", desc: "Premium cocktail bar landing page with cinematic scroll interactions and parallax effects.", stack: ["HTML", "SCSS", "GSAP"], img: "/projects/Juice.webp", href: "https://mojito-refresh.netlify.app" },
  { title: "Green Nest", tag: "Garden & Landscaping", index: "05", desc: "Garden and landscaping business landing page with nature-inspired design, GSAP animations, team profiles, client testimonials, Swiper slider, and EmailJS contact form.", stack: ["React 18", "Vite", "GSAP", "Swiper", "Tailwind CSS", "EmailJS"], img: "/projects/garden.png", href: "https://green-nest-omega.vercel.app" },
  { title: "Artificial Intelligence", tag: "Product Site", index: "06", desc: "AI-themed marketing site with animated typographic components and a modern editorial layout.", stack: ["React", "Vite", "Tailwind"], img: "/projects/ai.png", href: "https://artificial-intelligences.netlify.app" },
  { title: "Tickzo — Smart Watch", tag: "Product Page", index: "07", desc: "Interactive smart-watch showcase with crisp product imagery and a polished feature grid.", stack: ["React", "Tailwind", "Framer Motion"], img: "/projects/watch.webp", href: "https://tickzo.vercel.app" },
  { title: "Lumivio", tag: "Premium Agency", index: "08", desc: "Premium creative agency landing page with cinematic GSAP scroll animations, Framer Motion page transitions, Lenis smooth scroll, and a bold dark-themed UI.", stack: ["React 19", "Vite 7", "GSAP", "Framer Motion", "Lenis", "Tailwind CSS v4", "Lucide React"], img: "/projects/creative.png", href: "https://lumivio.vercel.app" },
  { title: "Galaxmind", tag: "AI SaaS Landing", index: "09", desc: "Next-generation AI SaaS landing page with a cinematic space-themed UI, Framer Motion animations, interactive planet showcase, features, pricing, and CTA sections.", stack: ["React 19", "Vite 7", "Framer Motion", "Tailwind CSS v4", "Lucide React"], img: "/projects/space.png", href: "https://galaxmind.netlify.app" },
